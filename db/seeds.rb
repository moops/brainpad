...
j1 = Journal.create({ person: adam, journal_type: default, entry: 'first test entry', tags: 'test', entry_on: Date.today - 2 })
j2 = Journal.create({ person: adam, journal_type: default, entry: 'second test entry', tags: 'test', entry_on: Date.today - 3 })
j3 = Journal.create({ person: adam, journal_type: default, entry: 'third test entry', entry_on: Date.today - 4 })
j4 = Journal.create({ person: adam, journal_type: default, entry: 'fourth test entry', entry_on: Date.today - 5 })

con1 = Connection.create({ person: adam, name: 'imdb', username: 'adam@raceweb.ca', password: 'clue', url: 'http://www.imdb.com', description: 'movie stuff', tags: 'movies' })
con1 = Connection.create({ person: adam, name: 'pandora', username: 'adam@raceweb.ca', password: 'clue', url: 'http://www.pandora.com', description: 'all my music', tags: 'music' })
con1 = Connection.create({ person: adam, name: 'cibc bank', username: 'adam@raceweb.ca', password: 'super secret', url: 'http://www.cibc.com', description: 'all my money', tags: 'bank' })

m1 = Milestone.create({ person: adam, name: 'high school', milestone_at: '1987-06-25' })
m1 = Milestone.create({ person: adam, name: 'quinn born', milestone_at: '1996-03-01' })
m1 = Milestone.create({ person: adam, name: 'else born', milestone_at: '1997-12-19' })
m1 = Milestone.create({ person: adam, name: 'trip to florida', milestone_at: '2012-03-07' })
...
r1 = Reminder.create({ person: adam, description: 'weed the garden', tags: 'home', due_on: Date.today, reminder_type: home, priority: low })
r2 = Reminder.create({ person: adam, description: 'groceries', tags: 'home', due_on: Date.today, reminder_type: home, priority: high })
r3 = Reminder.create({ person: adam, description: 'spending committee meeting', tags: 'coop', due_on: Date.today + 1, reminder_type: home, priority: low })
r4 = Reminder.create({ person: adam, description: 'doctor appointment', tags: 'home', due_on: Date.today + 1, reminder_type: home, priority: high })
r5 = Reminder.create({ person: adam, description: 'groceries', tags: 'home', due_on: Date.today + 1, reminder_type: home, priority: low })
r6 = Reminder.create({ person: adam, description: 'parent teacher meeting', tags: 'school', due_on: Date.today + 2, reminder_type: home, priority: high })
r7 = Reminder.create({ person: adam, description: 'download something', tags: 'home', due_on: Date.today + 2, reminder_type: home, priority: low })
r8 = Reminder.create({ person: adam, description: 'buy plane tickets', tags: 'home', due_on: Date.today + 2, reminder_type: home, priority: low })
r9 = Reminder.create({ person: adam, description: 'pay hydro bill', tags: 'home', due_on: Date.today + 3, reminder_type: home, priority: high })
r10 = Reminder.create({ person: adam, description: 'kids to jen\'s house', tags: 'home', due_on: Date.today + 4, reminder_type: home, priority: low })
