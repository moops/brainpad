...
Lookup.create({:category => 1, :code => 'interval', :description => 'reminder interval' })
Lookup.create({:category => 36, :code => '7', :description => 'week' })
Lookup.create({:category => 36, :code => '14', :description => 'two weeks' })
Lookup.create({:category => 36, :code => 'm', :description => 'month' })
Lookup.create({:category => 36, :code => '365', :description => 'year' })
Lookup.create({:category => 1, :code => 'freq', :description => 'frequency' })
Lookup.create({:category => 41, :code => '1', :description => 'daily' })
Lookup.create({:category => 41, :code => '7', :description => 'weekly' })
Lookup.create({:category => 41, :code => '14', :description => 'biweekly' })
Lookup.create({:category => 41, :code => '15', :description => 'twice monthly' })
